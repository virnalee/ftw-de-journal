=============================================================================
# 📓 Journal - 2026-09-01 - Day 3: Creating and Finalizing My First Query for Team Review
=============================================================================
...
- [x] Reviewed and approved Nella's Pull Request #7 (docs/test: update aisles/dept DQ validation findings)
- [x] Synced my fork and pulled the latest main into Databricks
- [x] Merged main into my own branch (virna) to catch it up
...
- [ ] Write and test a few Instacart query variations in my notebook
- [ ] Pick the query that gives the clearest, most accurate results and finalize it
...
- Will test and finalize queries in my notebook first, then copy finalized versions into my branch before opening a PR.
- Chose Q1 with Sara because it fits the star schema already built, and it lets us show a real data issue found while checking the data.
